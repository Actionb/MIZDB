...
class TestBuchForm(ModelFormTestCase):
    ...
    def test_is_buchband_to_false(self):
        ...
        form.full_clean()
        self.assertEqual(form.errors["is_buchband"], ["Nicht abwählbar für Buchband mit existierenden Aufsätzen."])
...
class TestPersonForm(ModelFormTestCase):
    ...
    def test_clean_raises_error_no_match_id_and_url(self, _searchgnd_mock):
        ...
        expected_error_message = "Die angegebene GND ID (1234) stimmt nicht mit der ID im DNB Link überein (11863996X)."
    ...
    def test_clean_sets_id_from_url(self, _searchgnd_mock):
        ...
        gnd_id was missing.
        """
        form = self.get_form(data={"dnb_url": "http://d-nb.info/gnd/11863996X", "nachname": "Plant"})
    ...
    def test_clean_sets_id_from_url_when_id_removed(self, _searchgnd_mock):
        ...
        form = self.get_form(
            ...
            initial={"gnd_id": "1234", "dnb_url": "http://d-nb.info/gnd/1234", "nachname": "Plant"},
        )
        self.assertTrue(form.is_valid(), form.errors)
        self.assertIn("gnd_id", form.cleaned_data)
        self.assertEqual(form.cleaned_data["gnd_id"], "11863996X")
    ...
    def test_clean_sets_gnd_id_from_url_when_url_changes(self, _searchgnd_mock):
        ...
        """
        form = self.get_form(
            data={"gnd_id": "1234", "dnb_url": "http://d-nb.info/gnd/11863996X", "nachname": "Plant"},
            initial={"gnd_id": "1234", "dnb_url": "http://d-nb.info/gnd/1234", "nachname": "Plant"},
        )
        self.assertTrue(form.is_valid(), form.errors)
    ...
    def test_clean_sets_url_from_gnd_id_when_url_missing(self, _searchgnd_mock):
        ...
        self.assertEqual(form.cleaned_data["dnb_url"], "http://d-nb.info/gnd/11863996X")
    ...
    def test_clean_sets_url_from_gnd_id_when_gnd_id_changes(self, _searchgnd_mock):
        ...
        """
        form = self.get_form(
            data={"gnd_id": "11863996X", "dnb_url": "http://d-nb.info/gnd/1234", "nachname": "Plant"},
            initial={"gnd_id": "1234", "dnb_url": "http://d-nb.info/gnd/1234", "nachname": "Plant"},
        )
        self.assertTrue(form.is_valid(), form.errors)
    ...
    def test_invalid_urls(self, _searchgnd_mock):
        ...
        self.assertIn("Bitte nur Adressen der DNB eingeben (d-nb.info oder portal.dnb.de).", form.errors["dnb_url"])
    ...
    def test_init_sets_gnd_id_initial_choice(self, _searchgnd_mock):
        ...
        obj = make(self.model, vorname="Robert", nachname="Plant", gnd_id="1234", gnd_name="Plant, Robert")
        form = self.get_form(instance=obj)
        self.assertEqual(form.fields["gnd_id"].widget.choices, [("1234", "Plant, Robert")])
