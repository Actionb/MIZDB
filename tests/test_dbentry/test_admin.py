...
class TestArtikelAdmin(AdminTestMethodsMixin, AdminTestCase):
    ...
    def test_kuenstler_string(self):
        obj = self.get_annotated_model_obj(self.obj1)
        self.assertEqual(self.model_admin.kuenstler_string(obj), 'Testband, Alice Tester')
...
class TestBestandAdmin(AdminTestMethodsMixin, AdminTestCase):
    ...
    fields_expected = [
        'lagerort', 'anmerkungen', 'provenienz', 'printmedia', 'audio', 'ausgabe', 'brochure',
        'buch', 'dokument', 'foto', 'memorabilien', 'plakat', 'technik', 'video'
    ]
