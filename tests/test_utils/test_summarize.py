...
class TestMusikerParser(ParserTestCase):
    ...
    def test_get_annotations(self):
        expected = ["band_list", "genre_list", "instrument_list", "alias_list", "ort_list", "url_list"]
        annotations = self.parser.get_annotations()
        self.assertCountEqual(list(annotations.keys()), expected)
...
class TestBandParser(ParserTestCase):
    ...
    def test_get_annotations(self):
        expected = ["musiker_list", "genre_list", "alias_list", "ort_list", "url_list"]
        annotations = self.parser.get_annotations()
        self.assertCountEqual(list(annotations.keys()), expected)
...
class TestAusgabeParser(ParserTestCase):
    ...
    def test_get_annotations(self):
        expected = ["jahr_list", "num_list", "lnum_list", "monat_list", "audio_list", "video_list", "bestand_list"]
        annotations = self.parser.get_annotations()
        self.assertCountEqual(list(annotations.keys()), expected)
...
class TestMagazinParser(ParserTestCase):
    ...
    def test_get_annotations(self):
        expected = ["url_list", "genre_list", "verlag_list", "herausgeber_list", "ort_list"]
        annotations = self.parser.get_annotations()
        self.assertCountEqual(list(annotations.keys()), expected)
...
class TestKalenderParser(ParserTestCase):
    ...
    def test_get_annotations(self):
        expected = ["jahr_list", "genre_list", "spielort_list", "veranstaltung_list", "url_list", "bestand_list"]
        annotations = self.parser.get_annotations()
        self.assertCountEqual(list(annotations.keys()), expected)
