...
class TestReplace(DataTestCase):
    ...
    def test__replace(self):
        ...
        self.assertQuerySetEqual(self.band1.genre.order_by("genre"), [self.replacement1, self.replacement2])
        self.assertQuerySetEqual(self.band2.genre.order_by("genre"), [self.extra, self.replacement1, self.replacement2])
    ...
    def test_replace(self):
        ...
        self.assertQuerySetEqual(self.musiker.genre.order_by("genre"), [self.replacement1, self.replacement2])
    ...
    def test_replace_reverse_relation_declared_on_obj(self):
        ...
        self.assertQuerySetEqual(self.audio.band.order_by("band_name"), [self.band2, self.band3])
