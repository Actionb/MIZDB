...
from tests.test_ac.models import Artikel, Ausgabe, Inherited
...
@override_settings(ROOT_URLCONF='tests.test_ac.urls')
class TestRemoteModelWidgetWrapper(MIZTestCase):
    ...
    def test_get_related_url(self):
        url = self.widget.get_related_url(('test_ac', 'ausgabe'), 'change', '__fk__')
        self.assertEqual(url, "/admin/test_ac/ausgabe/__fk__/change/", )

        url = self.widget.get_related_url(('test_ac', 'ausgabe'), 'add')
        self.assertEqual(url, "/admin/test_ac/ausgabe/add/")

        url = self.widget.get_related_url(('test_ac', 'ausgabe'), 'delete', '__fk__')
        self.assertEqual(url, "/admin/test_ac/ausgabe/__fk__/delete/")
    ...
    def test_get_context_can_change(self):
        with patch.object(self.widget, 'can_change_related', True):
            ...
            self.assertEqual(
                ...
                "/admin/test_ac/ausgabe/__fk__/change/"
            )
    ...
    def test_get_context_can_delete(self):
        with patch.object(self.widget, 'can_delete_related', True):
            ...
            self.assertEqual(
                ...
                "/admin/test_ac/ausgabe/__fk__/delete/"
            )
