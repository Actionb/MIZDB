...
class Artikel(models.Model):
    ausgabe = models.ForeignKey("test_admin_autocomplete.Ausgabe", on_delete=models.PROTECT)


class Band(models.Model):
    band_name = models.CharField("Bandname", max_length=200)
    genre = models.ManyToManyField("test_admin_autocomplete.Genre")
    musiker = models.ManyToManyField("test_admin_autocomplete.Musiker")
