...
class BaseViewMixin(ContextMixin):
    ...
    def get_help_url(self):
        """Return the URL to the corresponding help page."""
        return self.help_url or reverse("help", kwargs={"page_name": "index"})
...
class BaseEditView(
    ...
    def dispatch(self, request, *args, **kwargs):
        try:
            ...
            messages.warning(
                request,
                mark_safe(f"{icon} {self.opts.verbose_name} mit ID '{pk}' existiert nicht. Vielleicht gelöscht?"),
            )
    ...
    def get_success_message(self, cleaned_data):
        ...
        if self.add:
            ...
            return mark_safe(
                f"{icon} {self.opts.verbose_name} '{get_obj_link(self.request, self.object)}' erfolgreich geändert."
            )
