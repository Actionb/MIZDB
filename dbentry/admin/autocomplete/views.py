    ...
    def display_create_option(self, context: dict, q: str) -> bool:
        ...
        if self.create_field and q:
            if self.prevent_duplicates:
                ...
                existing_options = (self.get_result_label(result).lower() for result in context["object_list"])
...
class ACTabular(ACBase):
    ...
    def render_to_response(self, context: dict) -> http.JsonResponse:
        ...
        return http.JsonResponse({"results": results, "pagination": {"more": self.has_more(context)}})
