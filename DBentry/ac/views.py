...
class ACBase(autocomplete.Select2QuerySetView, LoggingMixin):
    ...
    def has_add_permission(self, request):
        # Overwritten since get_queryset() may return a list
        # (of exact matches, startswith matches and contains matches) now too.
        # Plus, autocomplete views have a model attribute anyhow. This avoids
        # doing anything expensive in get_queryset.
