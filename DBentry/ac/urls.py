...
urlpatterns = [
    ...
    path('<str:model_name>/<str:create_field>/', ACBase.as_view(), name='accapture'), 
    # ACCreateable has a more involved object creation process and gets the create_field directly from the model.
