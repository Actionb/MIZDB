...
from .views import ACAusgabe, ACBase, ACProv, ACVDStrat, ACGenre
from DBentry.models import *

autocomplete_patterns = [
#    url(r'^audio/$',        ACBase.as_view(model = audio, create_field = 'titel'),              name = "acaudio"), 
#    url(r'^ausgabe/$',      ACVDStrat.as_view(model=ausgabe),                                                name = 'acausgabe'), 
...
#    url(r'^genre/$',        ACGenre.as_view(model = genre, create_field='genre'),                name = 'acgenre'),
...
wip = [ 
    ...
    url(r'^(?P<model_name>\w+)/$', ACCapture.as_view(), name='accapture'), 
]
...
urlpatterns = [
    ...
    url(r'', include(autocomplete_patterns_nocreate))
]
