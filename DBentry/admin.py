...
class ModelBase(admin.ModelAdmin):
    ...
    def response_action(self, request, queryset):
        ...
        if action_form.is_valid():
            ...
            if inspect.isclass(func) and issubclass(func, ActionConfirmationView):
                # func is actually CBV, get it's as_view() inner view function 
                response = func.as_view(model_admin=self, queryset=queryset)(request)
            else:
