...
def help_link(context):
    """Create a link to the help page of the view included in context."""
    from DBentry.help.registry import halp
    if 'request' in context:
        request = context['request']
    elif 'view' in context and hasattr(context['view'], 'request'):
        # Get the request through the view context item that was added by
    ...
    if hasattr(request.resolver_match.func, 'model_admin'):
        ...
        # This is not a ModelAdmin view, it's a 'custom' view;
        # get the helpview's url.
